...
public class SimulatorView extends JFrame {
    ...
    private SimulatorController simulateController;
	...
	public SimulatorView(int height, int width, Simulator simulator) {
		...
		// Nieuwe fieldstats aanmaken
		stats = new FieldStats();
		// Kleuren voor dieren
		colors = new LinkedHashMap<Class, Color>();
		
		// Controller aanroepen van de simulator
        simulateController = new SimulatorController(this, simulator);
		...
		leftPanel.add(simulateController);
		...
		// Applicatie wordt helemaal afgesloten bij klikken op kruisje
